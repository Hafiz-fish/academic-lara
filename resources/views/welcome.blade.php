...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Academic Quiz Apps</title>
        ...
        <header id="header-section">
          ...
          <div class="banner" >
            <div class="container mt-5">
              <h1 class="font-weight-semibold">Selamat Datang di Aplikasi Quiz Laravel</h1>
              <h6 class="font-weight-normal text-muted pb-3">Melatih siswa akademi dengan latihan soal</h6>
              <div>
                    <a href="{{ url('/login') }}" class="btn btn-opacity-light mr-1"><b>Login</b></a>
                    <a href="{{ route('register') }}"class="btn btn-opacity-success ml-1"><b>Daftar</b></a>
              </div>
